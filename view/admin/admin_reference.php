...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <input name="create" type="submit" value="<?= $content[6] ?>">
</form>
...
<?php if (isset ($_POST['read'])) { ?>
    ...
    <form method="post">
        <button type="submit" name="view_update" value="<?= $read['id_contents'] ?>"><?= $content[14] ?></button>
        <button type="submit" name="delete" value="<?= $read['id_contents'] ?>"><?= $content[15] ?></button>
        <button type="submit" name="back"><?= $content[19] ?></button>
    </form>
<?php } ?>
...
<?php if (isset ($_POST['view_update'])) { ?>
    <form method="post">
        ...
        <button type="submit" name="update" value="<?= $view_update['id_contents']; ?>"><?= $content[14] ?></button>
        <button type="submit" name="back"><?= $content[19] ?></button>
    </form>
<?php } ?>
...
<?php if (isset ($_POST['view_update_pics'])) { ?>
    <form method="post" enctype="multipart/form-data">
        ...
        <button type="submit" name="update_pics" value="<?= $view_update_pics['id_pics'] ?>"><?= $content[14] ?></button>
        <button type="submit" name="back"><?= $content[19] ?></button>
    </form>
<?php } ?>
...
<?php if (isset($_POST['delete'])) { ?>
    <form method="post" enctype="multipart/form-data">
        ...
        <button type="submit" name="non"><?= $content[10] ?></button>
    </form>
<?php } ?>
